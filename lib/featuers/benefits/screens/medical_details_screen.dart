...
class MedicalDetailsScreen extends ConsumerStatefulWidget {
  ...
  MedicalDetailsScreen(
      {super.key, this.medicalModel, required this.collection});
            ...
            child: Stack(
              children: [
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () => Get.to(() => ToggleScreen(
                          price: widget.medicalModel!.price * 100)),
                      child: Material(
                        elevation: 5.0,
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "${widget.medicalModel!.price}\EGP/Month",
                                  style: TextStyle(
                                      fontFamily: "Muller",
                                      color: Pallete.whiteColor,
                                      fontSize: size.width * 0.04,
                ...
                Positioned(
                    ...
                    child: InkWell(
                      onTap: () => openWhatsApp(
                          ref, widget.medicalModel!.whatAppNum, context),
                      child: Image.asset(
