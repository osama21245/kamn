...
import 'package:kman/featuers/benefits/screens/medical_add_screen.dart';
import 'package:kman/featuers/benefits/screens/nutrtion_add_screen.dart';
import 'package:kman/featuers/benefits/screens/sports_add_screen.dart';
...
enum BenefitsFilterStatus { Medical, Nutrition, Sports }
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          if (status == BenefitsFilterStatus.Medical) {
            Get.to(() => AddMedicalScreen());
          } else if (status == BenefitsFilterStatus.Nutrition) {
            Get.to(() => AddNutrtionScreen());
          } else {
                              ...
                              setState(() {
                                if (filterStatus ==
                                  ...
                                  _alignment = Alignment.center;
                                    ...
                                    BenefitsFilterStatus.Sports) {
                                  status = BenefitsFilterStatus.Sports;
